...
description: Shared vocabulary for designing deep modules. Use when the user wants to design or improve a module's interface, find deepening opportunities, decide where a seam goes, make code more testable or AI-navigable, or when another skill needs the deep-module vocabulary. NOT for: applying quality cleanups to a finished diff (use /simplify), or hunting a codebase for defects (use bug-hunt / adversarial-review).
---
